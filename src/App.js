...
const SOC_PLATFORMS = [
  {
    ...
    formats: [
      { id: "reels", label: "Reels 短影片", maxLen: 80, rules: "建議60-80字（不含固定聯絡資訊區塊），2-3句。每句畫面感，✦ 起手 Hook。三版本情緒不同：A溫柔、B清醒、C療癒。禁用「值得」「推薦」「必買」。【極重要】copy 欄位必須包含完整聯絡資訊四行（線上訂購/訂購專線/LINE官方/B2B私訊），原樣輸出不要省略，沒寫=失敗。【IG Hashtag 2026規則】最多5個，固定 #天下第一好茶 #BESTEA，再加3個精準中型標籤(5萬-50萬貼文量)。title欄位留空。" },
    ],
  },
  {
